...
const peopleSearchTab: CustomTab = {
    name: "People search",
    getFields(entry) {
...
const suggestionsTab: CustomTab = {
    name: "Suggestions",
    getFields(entry) {
        ...
        if (peopleResults) {
            ...
            peopleResults.Suggestions.forEach((suggestion: any) => {
                fields.push({
                    type: "container",
                    style: "accordeon",
                    label: (suggestion.Text || suggestion.DisplayName) + (suggestion.UserPrincipalName ? ` (${suggestion.UserPrincipalName})` : ""),
                    fields: [
                        {
                            // type: "table",
                            // headers: [
